...
final_tab %>% 
  ...
  labs(y = "Odds Ratio with 95% CI\n(log scale)",
       ...
       subtitle = "Age, gender, and deprivation adjusted",
...
fig_3 <- upset(ckd_upset, morbs, name = "Morbidities",
               base_annotations = list(
                 "Intersection size" = intersection_size(
                   ...
                   text = list(size = 6, vjust = -0.5, hjust = -0.05, angle = 60))),
               width_ratio = 0.1,
               height_ratio = 1, 
               min_size = 75,
...
ggsave("plots/fig_3.tiff", fig_3, width = 22, height = 14, dpi = 300)
```

## Count combinations

Confirmation of the number of unique combinations of diseases (not including CKD on its own)
